# Validation report — LMSPilot 0.15.0
...
Kết quả build/render 0.14 chỉ là bằng chứng lịch sử cho nền giao diện, không phải xác nhận build của 0.15. Xem `../PERMISSION_FIRST_0.15.0.md`, `../../TEST_RESULTS_LMSPILOT_0.15.0.md` và `../../DELIVERY_STATUS.md`.
