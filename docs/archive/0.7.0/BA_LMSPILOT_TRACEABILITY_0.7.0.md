# Ma trận truy vết BA + yêu cầu LMSPilot — LMSPilot 0.7.0
...
| Yêu cầu LMSPilot | Hai account type, ba role mặc định, nhiều role và cấp hàng loạt | IMPLEMENTED | `SYSTEM_ADMIN` duy nhất được bảo vệ |
