# LMSPilot 0.15.0 — Permission-first release candidate
...
Đây là full-source release candidate, chưa phải chứng nhận production. 127 test regression đạt; platform-contracts compile đạt; TypeScript syntax parse đạt. Full npm/Gradle/Docker verification chưa chạy được trong môi trường đóng gói. Xem `docs/PERMISSION_FIRST_0.15.0.md`, `TEST_RESULTS_LMSPILOT_0.15.0.md` và `DELIVERY_STATUS.md`.
