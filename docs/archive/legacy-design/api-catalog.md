...
| Giao khóa học/ghi danh/buổi trực tuyến | `/api/v1/enrollments/**`, `/api/v1/course-assignments/**`, `/api/v1/live-sessions/**` |
...
- Enrollment/course-assignment/user-course lookup; delivery IDs cũ chỉ dùng nội bộ để giữ tương thích dữ liệu.
