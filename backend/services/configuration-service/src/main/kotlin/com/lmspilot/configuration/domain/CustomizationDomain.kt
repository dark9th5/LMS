...
class BrandingProfileEntity(
    ...
    var systemName: String = "LMSPilot",
    ...
    var themeKey: String = "unified-light",
    @Column(name = "primary_color", nullable = false, length = 9) var primaryColor: String = "#2563EB",
    @Column(name = "secondary_color", nullable = false, length = 9) var secondaryColor: String = "#475569",
    @Column(name = "background_color", nullable = false, length = 9) var backgroundColor: String = "#F6F7F9",
    @Column(name = "text_color", nullable = false, length = 9) var textColor: String = "#172033",
