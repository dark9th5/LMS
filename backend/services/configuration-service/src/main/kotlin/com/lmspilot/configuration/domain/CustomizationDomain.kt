...
class BrandingProfileEntity(
    ...
    @Column(name = "primary_color", nullable = false, length = 9) var primaryColor: String = "#8B5CF6",
    @Column(name = "secondary_color", nullable = false, length = 9) var secondaryColor: String = "#14B8A6",
    @Column(name = "background_color", nullable = false, length = 9) var backgroundColor: String = "#080B18",
    @Column(name = "text_color", nullable = false, length = 9) var textColor: String = "#F7F4FF",
