...
import static com.lmspilot.support.security.JwtDecoderConfiguration.hmacKey;
...
public class IdentitySecurityConfiguration {
    ...
    @Bean JwtEncoder jwtEncoder(@Value("${lmspilot.jwt.secret}") String secret){
        return new NimbusJwtEncoder(new ImmutableSecret<SecurityContext>(hmacKey(secret)));
    }
