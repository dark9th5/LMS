...
class LearningPathService(
    ...
    private fun requireManager(entity: LearningPathEntity? = null) {
        if (Permissions.LEARNING_PATHS_MANAGE in CurrentUser.authorities() || entity?.ownerId == CurrentUser.id()) return
    ...
    private fun requireAssigner(entity: LearningPathEntity) {
        if (Permissions.LEARNING_PATHS_ASSIGN in CurrentUser.authorities() || entity.ownerId == CurrentUser.id()) return
