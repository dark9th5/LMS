...
@Entity @Table(name="course_versions",uniqueConstraints=@UniqueConstraint(name="uq_course_version_number",columnNames={"course_id","version_number"}),indexes=@Index(name="idx_course_version_course",columnList="course_id,version_number"))
public class CourseVersionEntity {
 @Id public UUID id=UUID.randomUUID();
 @Column(name="course_id",nullable=false) public UUID courseId;
 @Column(name="version_number",nullable=false) public int versionNumber=1;
