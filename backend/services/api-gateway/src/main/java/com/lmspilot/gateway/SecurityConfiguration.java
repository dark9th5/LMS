...
public class SecurityConfiguration {
  @Bean
  public ReactiveJwtDecoder reactiveJwtDecoder(@Value("${lmspilot.jwt.secret}") String secret) {
  ...
  public SecurityWebFilterChain gatewaySecurity(ServerHttpSecurity http, ReactiveJwtDecoder decoder) {
    ...
    return http
        ...
        .exceptionHandling(e -> e.authenticationEntryPoint((exchange, ex) -> unauthorized(exchange.getResponse())))
        ...
        .oauth2ResourceServer(o -> o
            ...
            .authenticationEntryPoint((exchange, ex) -> unauthorized(exchange.getResponse())))
        .build();
  }
