...
public class DevelopmentSeed implements ApplicationRunner {
    ...
    public DevelopmentSeed(CompetencyRepository c,CompetencyProfileRepository p,CompetencyProfileRequirementRepository r,@Value("${lmspilot.seed-demo:false}") boolean e){
        competencies=c;
        profiles=p;
        requirements=r;
        enabled=e;
