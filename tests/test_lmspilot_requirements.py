...
class ClsRequirementTraceTests(unittest.TestCase):
    ...
    def test_course_quiz_standalone_exam_and_competition_are_distinct(self) -> None:
        policy = text("backend/services/assessment-service/src/main/kotlin/com/lmspilot/assessment/platform/AssessmentContextPolicy.kt")
    ...
    def test_objective_questions_are_auto_graded(self) -> None:
        scoring = text("backend/services/assessment-service/src/main/kotlin/com/lmspilot/assessment/platform/ObjectiveScoring.kt")
    ...
    def test_ai_question_generation_has_local_api_and_common_schema(self) -> None:
        ...
        schema_path = ROOT / "contracts/lmspilot/question-set.schema.json"
    ...
    def test_learner_live_sessions_backend_is_retained_but_core_ui_is_retired(self) -> None:
        ...
        self.assertNotIn('"live-sessions"', route)
    ...
    def test_ai_generation_is_course_scoped_and_schema_is_packaged(self) -> None:
        ...
        canonical = ROOT / "contracts/lmspilot/question-set.schema.json"
        self.assertIn("CourseDocumentScopeClient", api)
        self.assertIn('/internal/v1/courses/{id}/document-scope', api)
        self.assertIn("requireCoursePermission(normalizedInput.courseId", api)
        self.assertIn("DOCUMENT_OUTSIDE_COURSE", api)
    ...
    def test_competition_backend_is_retained_but_core_ui_is_retired(self) -> None:
        ...
        self.assertNotIn('"competitions"', route)
        self.assertIn("if (!target) notFound()", route)
    ...
    def test_assignment_submission_is_a_dedicated_scoped_aggregate(self) -> None:
        ...
        self.assertIn("requireCourseScope", api)
        self.assertNotIn("requireClassScope", api)
