...
const mutationTimeoutMs = positiveInteger(
  process.env.LMSPILOT_UPSTREAM_MUTATION_TIMEOUT_MS,
  25_000,
);
const authTimeoutMs = positiveInteger(
  process.env.LMSPILOT_AUTH_UPSTREAM_TIMEOUT_MS,
  20_000,
);
const longRunningTimeoutMs = positiveInteger(
  process.env.LMSPILOT_AI_UPSTREAM_TIMEOUT_MS,
  300_000,
);
