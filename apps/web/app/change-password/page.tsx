    ...
    <main className="auth-page password-page">
      <section className="password-intro">
        <span className="auth-pill">
          <Icon name="lock" size={16} /> Bảo mật tài khoản
        </span>
        ...
        <div className="password-guide">
          <span>
            <Icon name="check" size={18} /> Tối thiểu 12 ký tự
          </span>
          <span>
            <Icon name="check" size={18} /> Có chữ hoa, chữ thường và số
          </span>
          <span>
            <Icon name="check" size={18} /> Có ít nhất một ký tự đặc biệt
          </span>
        </div>
      </section>
