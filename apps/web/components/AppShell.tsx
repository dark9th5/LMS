    ...
    items: [
      {
        href: "/admin",
        label: "Tổng quan",
        hint: "Vận hành và chỉ số hệ thống",
        icon: "dashboard",
      },
      {
        href: PORTAL_PATHS.ADMIN.users,
        label: "Người dùng",
        hint: "Tài khoản và vai trò",
        icon: "users",
      },
      {
        href: PORTAL_PATHS.ADMIN.organization,
        label: "Tổ chức",
        hint: "Cơ cấu và thành viên",
        icon: "building",
      },
      {
        href: PORTAL_PATHS.ADMIN.reports,
        label: "Báo cáo",
    ...
    items: [
      {
        href: "/instructor",
        label: "Tổng quan",
        hint: "Công việc giảng dạy",
        icon: "dashboard",
      },
      {
        href: PORTAL_PATHS.INSTRUCTOR.courses,
        label: "Khóa học",
        hint: "Bài học và bài kiểm tra",
        icon: "book",
      },
      {
      ...
      {
        href: PORTAL_PATHS.INSTRUCTOR.reports,
        label: "Báo cáo",
        hint: "Tiến độ học viên",
        icon: "report",
      },
    ],
  },
    ...
    items: [
      {
        href: "/student",
        label: "Tổng quan",
        hint: "Lịch học và việc cần làm",
        icon: "dashboard",
      },
      {
        href: PORTAL_PATHS.STUDENT.courses,
        label: "Khóa học",
        hint: "Nội dung đang học",
        icon: "book",
      },
      {
        href: PORTAL_PATHS.STUDENT.exams,
        label: "Bài thi",
        hint: "Kỳ thi được giao",
        icon: "exam",
      },
      {
      ...
      {
        href: PORTAL_PATHS.STUDENT.certificates,
        label: "Chứng chỉ",
        hint: "Chứng nhận đã đạt",
        icon: "certificate",
      },
    ],
  },
...
export function AppShell({
  ...
  useEffect(() => {
    ...
    setSidebarCollapsed(
      window.localStorage.getItem("lms-sidebar-collapsed") === "true",
    );
  }, []);
        ...
        <header className="app-topbar">
          <div className="topbar-leading">
            ...
            <div className="topbar-context">
              <small>{navigation.workspaceLabel}</small>
          ...
          >
            <Icon name="search" size={18} />
            <span>
              Tìm trong chức năng của{" "}
              {roleLabel(role).toLocaleLowerCase("vi-VN")}
            </span>
            <kbd>Ctrl K</kbd>
          </button>
